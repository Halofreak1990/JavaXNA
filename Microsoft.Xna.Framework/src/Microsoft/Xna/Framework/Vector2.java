...
public final class Vector2 extends ValueType implements IEquatable<Vector2>
{
	 ...
	 */
	public static void Distance(Vector2 value1, Vector2 value2, float result)
	{
	    float num2 = value1.X - value2.X;
	    float num = value1.Y - value2.Y;
	    float num3 = (num2 * num2) + (num * num);
	 ...
	 */
	public static void DistanceSquared(Vector2 value1, Vector2 value2, float result)
	{
	    float num2 = value1.X - value2.X;
	    float num = value1.Y - value2.Y;
	...
	{
		return (obj instanceof Vector2) ? this.Equals((Vector2)obj) : false;
	}
